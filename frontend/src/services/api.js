...
export const companyService = {
  ...
  registerSendOtp: (data) => api.post("/company/register/send-otp", data),
  registerVerifyOtp: (data) => api.post("/company/register/verify-otp", data),
  registerResendOtp: (data) => api.post("/company/register/resend-otp", data),
